...
/// <summary>
/// LLM provider client for OpenRouter
/// </summary>
public class OpenRouterClient : ILlmProvider
{
    ...
    public OpenRouterClient(HttpClient httpClient, string apiKey, string model)
    {
    ...
    public async Task<LlmResponse> CompleteAsync(LlmRequest request, CancellationToken ct = default)
    {
        try
        {
            ...
            httpRequest.Headers.Add("HTTP-Referer", "https://github.com");
            ...
            if (!response.IsSuccessStatusCode)
            {
                return new LlmResponse
                {
                    ...
                    Error = $"OpenRouter API error ({response.StatusCode}): {responseBody}"
                };
            }
        ...
        catch (Exception ex)
        {
            ...
            {
                Content = string.Empty,
                Error = $"OpenRouter request failed: {ex.Message}"
            };
        }
    }
